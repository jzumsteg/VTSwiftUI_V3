...
//let kTenses = ["presente","imperfecto", "pretérito", "futuro", "condicional presente", "presente de subjuntivo", "imperfecto de subjuntivo", "imperfecto de subjuntivo (alt)", "imperativo", "perfecto de indicativo", "pluscuamperfecto de indic.", "pretérito anterior", "futuro perfecto", "condicional compuesto", "perfecto de subjuntivo", "pluscuam. de subj.","pluscuam. de subj. (alt)"]

let kSimpleTenses = ["All simple tenses", "Presente","Imperfecto","Pretérito","Futuro","Condicional presente","Presente de subjuntivo","Imperfecto de subjuntivo","Imperfecto de subjuntivo (alt)", "Imperativo"]
let kCompoundTenses = ["All compound tenses","Perfecto de indicativo","Pluscuamperfecto de indic.", "Pretérito anterior","Futuro perfecto","Condicional compuesto","Perfecto de subjuntivo", "Pluscuam. de subj.","Pluscuam. de subj. (alt)"]
let kEndings = ["All infinitive endings","-ar","-ir", "-er"]
let kTypes = ["All verb types", "Regular","Irregular", "Stem-changing","Ortho-changing","Reflexive","Use vosotros"]
let kPersons = ["All Person/Numbers", "Yo","Tú","Ella","El","Ud.","Nosotros","Vos","Ellos","Ellas","Uds."]
