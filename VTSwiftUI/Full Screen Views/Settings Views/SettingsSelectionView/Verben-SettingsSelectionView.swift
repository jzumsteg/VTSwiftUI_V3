//
//  Verben-SettingsSelectionView.swift
//  Verben
//
...
//        let allSettings = State(initialValue: AllVerbSettingsGroup())
        ...
        _simple1 = State(initialValue: settingsModel.getState(name: "präsens indicativ")!)
        _simple2 = State(initialValue: settingsModel.getState(name: "präteritum indicativ")!)
        _simple3 = State(initialValue: settingsModel.getState(name: "futur")!)
        _simple4 = State(initialValue: settingsModel.getState(name: "präsens konjuntiv")!)
        _simple5 = State(initialValue: settingsModel.getState(name: "präteritum konjunktiv")!)
        _simple6 = State(initialValue: settingsModel.getState(name: "futur konjunktiv")!)
        _simple7 = State(initialValue: settingsModel.getState(name: "imperativ")!)
        
        _compoundAll = State(initialValue: settingsModel.getState(name: "All Compound Tenses")!)
        _compound1 = State(initialValue: settingsModel.getState(name: "perfekt indicativ")!)
        _compound2 = State(initialValue: settingsModel.getState(name: "plusquamperfekt indicativ")!)
        _compound3 = State(initialValue: settingsModel.getState(name: "futur perfekt")!)
        _compound4 = State(initialValue: settingsModel.getState(name: "perfekt konditional")!)
        _compound5 = State(initialValue: settingsModel.getState(name: "plusquamperfekt konjunktiv")!)
        _compound6 = State(initialValue: settingsModel.getState(name: "perfekt konjunktiv")!)
        _compound7 = State(initialValue: settingsModel.getState(name: "futur perfekt konjunktiv")!)
        ...
        _person1 = State(initialValue: settingsModel.getState(name: "ich")!)
        _person2 = State(initialValue: settingsModel.getState(name: "du")!)
        _person3 = State(initialValue: settingsModel.getState(name: "er")!)
        _person4 = State(initialValue: settingsModel.getState(name: "sie (sing.)")!)
        _person5 = State(initialValue: settingsModel.getState(name: "es")!)
        _person6 = State(initialValue: settingsModel.getState(name: "Sie (pl.)")!)
        _person7 = State(initialValue: settingsModel.getState(name: "wir")!)
        _person8 = State(initialValue: settingsModel.getState(name: "ihr")!)
        _person9 = State(initialValue: settingsModel.getState(name: "sie (pl.)")!)
        _person10 = State(initialValue: settingsModel.getState(name: "Sie (sing.)")!)
